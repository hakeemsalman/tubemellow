...
export default function Input({ onChange, isToggle, id, data}) {
  ...
  return (
    <div className="relative inline-block w-11 h-5" >
      <input checked={isChecked} id={id} onChange={handleToggle} name={data} type="checkbox" className="peer appearance-none w-11 h-5 bg-slate-100 rounded-full checked:bg-slate-800 cursor-pointer transition-colors duration-300" />
